...
function peg$parse(input, options) {
  ...
  function peg$parsekeyValue() {
    ...
    s0 = peg$parsekeyOneValue();
    if (s0 === peg$FAILED) {
      s0 = peg$parsekeyManyValues();
    }

    return s0;
  }

  function peg$parsekeyOneValue() {
    var s0, s1, s2, s3, s4;
  ...
  function peg$parsekeyManyValues() {
